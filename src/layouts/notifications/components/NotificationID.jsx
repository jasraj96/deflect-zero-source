              ...
              <Table aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="right" width={100}>Customer ID</StyledTableCell>
                    <StyledTableCell align="right">Date</StyledTableCell>
                    <StyledTableCell align="center">Email</StyledTableCell>
                    <StyledTableCell align="right">Number</StyledTableCell>
                    <StyledTableCell align="center" width={400}>Details</StyledTableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {notification.map((row) => (
                    ...
                    >
                      ...
                      <TableCell align="right">{moment(row.dateTime).format("YYYY-MM-DD h:mm a")}</TableCell>
